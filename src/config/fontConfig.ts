...
export const fontsList: FontDefinition[] = [
  ...
  {
    name: "Maple Mono CN",
    cssVariable: "--font-maple-mono-cn",
    provider: "local",
    options: {
      variants: [
        {
          src: [
            "./public/assets/fonts/maple-mono-cn/MapleMono-CN-Regular.ttf",
          ],
          weight: "400",
          style: "normal",
        },
        {
          src: [
            "./public/assets/fonts/maple-mono-cn/MapleMono-CN-Medium.ttf",
          ],
          weight: "500",
          style: "normal",
        },
        {
          src: [
            "./public/assets/fonts/maple-mono-cn/MapleMono-CN-SemiBold.ttf",
          ],
          weight: "600",
          style: "normal",
        },
        {
          src: [
            "./public/assets/fonts/maple-mono-cn/MapleMono-CN-Bold.ttf",
          ],
          weight: "700",
          style: "normal",
        },
